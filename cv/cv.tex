...
\>                \> 381 E Evelyn Ave          \> Email Address: \> \url{nick.eriksson@gmail.com}\\
\>                \>Mountain View, CA\ \ 94041 \> Homepage:      \>\url{http://www.stat.uchicago.edu/~eriksson}\\
\> Date of Birth: \> 1978 (Montana, USA)       \> Date of CV:    \> October 2016
\end{tabbing}
...
\item \textbf{Programming:} Python, R, SQL
\end{progress}
...
\vspace{-2ex}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\marginlabel{\sf Peer-reviewed and submitted articles (41 total, 18 as first/last/unordered author)}%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\marginlabel{\sf Peer-reviewed articles (18 as first/last/unordered author)}%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\begin{papers}[41]%\setcounter{enumi}{\value{separated}}%restores \enumi
