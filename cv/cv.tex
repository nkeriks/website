...
\> Date of Birth: \> 1978 (Montana, USA)       \> Date of CV:    \> November 2013
\end{tabbing}
...
\vspace{-2ex}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\marginlabel{\sf Peer-reviewed and submitted articles (30 total, 17 as first/last/unordered author)}%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\marginlabel{\sf Peer-reviewed articles (17 as first/last/unordered author)}%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\begin{papers}[30]%\setcounter{enumi}{\value{separated}}%restores \enumi
        ...
        \textit{Journal of Data Mining in Genomics \& Proteomics}, to appear, 2013.
